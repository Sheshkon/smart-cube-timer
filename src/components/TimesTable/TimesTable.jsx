          ...
          <div className='flex mb-4'>
            ...
            <div className='flex items-center'>
              ...
              <RenameSessionModal
                ...
                currentSession={sessions?.filter((el) => el?.id == settings?.selectedSessionId)[0]}
                sessions={sessions}
              />
                ...
                <div className='flex justify-center items-center space-x-1 sm:space-x-2 mt-4 py-2 text-gray-700 dark:text-gray-300'>
                  ...
                  {getPageNumbers().map((page, index) =>
                    typeof page === 'number' ? (
                      ...
                      <span
                        key={`ellipsis-${index}`}
                        className='px-1 sm:px-2 py-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400'
                      >
                        {page}
                      </span>
                    )
                ...
                <dialog open className='modal'>
                  <div className='modal-box relative'>
                    ...
                    <textarea
                      ...
                      name='Text1'
                      cols='10'
                      rows={formatSolveData(popupContent).split('\n').length}
                      readOnly={true}
                    />
