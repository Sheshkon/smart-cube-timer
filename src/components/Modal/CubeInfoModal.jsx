                ...
                <dialog open className="modal">
                    <div className="modal-box">
                        <div className="flex justify-between">
                            <b><label htmlFor="batteryLevel">Battery</label></b>
                            <input
                                id="batteryLevel"
                                type="text"
                                readOnly
                        ...
                        <div className="flex justify-between">
                            <b><label htmlFor="deviceMAC">Device MAC</label></b>
                            <input
                                id="deviceMAC"
                                type="text"
                                readOnly
                        ...
                        <div className="flex justify-between">
                            <b><label htmlFor="deviceName">Device Name</label></b>
                            <input
                                id="deviceName"
                                type="text"
                                readOnly
                        ...
                        <div className="flex justify-between">
                            <b><label htmlFor="gyroSupported">Gyro Supported</label></b>
                            <input
                                id="gyroSupported"
                                type="text"
                                readOnly
                        ...
                        <div className="flex justify-between">
                            <b><label htmlFor="hardwareName">Hardware Name</label></b>
                            <input
                                id="hardwareName"
                                type="text"
                                readOnly
                        ...
                        <div className="flex justify-between">
                            <b><label htmlFor="softwareVersion">Software Version</label></b>
                            <input
                                id="softwareVersion"
                                type="text"
                                readOnly
                        ...
                        <div className="flex justify-between">
                            <b><label htmlFor="hardwareVersion">Hardware Version</label></b>
                            <input
                                id="hardwareVersion"
                                type="text"
                                readOnly
