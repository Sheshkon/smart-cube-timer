...
var FaceTree = class _FaceTree {
  ...
  split(q) {
    ...
    if (t !== null) {
      if (this.left === void 0) {
        ...
        this.left = (_a2 = this.left) == null ? void 0 : _a2.split(q);
  ...
  collect(arr, leftfirst) {
    ...
    if (this.left === void 0) {
      ...
      (_a2 = this.left) == null ? void 0 : _a2.collect(arr, false);
...
${svg.join(
  ...
  get3d(options) {
    ...
    for (let i = 0; i < this.faces.length; i++) {
      ...
      const cubiesetnum = this.cubiesetnums[cubie];
      const cubieord = this.cubieordnums[cubie];
      let color = this.graybyori(cubie) ? (options == null ? void 0 : options.darkIgnoredOrbits) ? "#222222" : "#808080" : this.colors[this.facenames[facenum][1]];
...
//# sourceMappingURL=puzzle-geometry-OIDTSNXH.js.map
