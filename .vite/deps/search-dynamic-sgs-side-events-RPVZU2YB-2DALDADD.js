...
import "./chunk-ADOABKV4.js";
import "./chunk-WOOG5QLI.js";

// node_modules/cubing/dist/lib/cubing/chunks/search-dynamic-sgs-side-events-RPVZU2YB.js
var cachedData = null;
...
async function megaminxKPuzzleWithoutMO() {
  const { getPuzzleGeometryByName, ExperimentalPGNotation } = await import("./puzzle-geometry-OIDTSNXH.js");
...
var cachedData2 = null;
async function cachedSGSDataMegaminx() {
  return cachedData2 ?? (cachedData2 = sgsDataMegaminx());
}
...
var cachedData3 = null;
async function sgsDataPyraminx() {
  return cachedData3 ?? (cachedData3 = uncachedSGSDataPyraminx());
}
...
async function skewbKPuzzleWithoutMOCached() {
  return defCache2 ?? (defCache2 = skewbKPuzzleWithoutMO());
}
var cachedData4 = null;
async function sgsDataSkewb() {
  return cachedData4 ?? (cachedData4 = uncachedSGSDataSkewb());
}
...
//# sourceMappingURL=search-dynamic-sgs-side-events-RPVZU2YB-2DALDADD.js.map
