...
// node_modules/cubing/dist/lib/cubing/chunks/twisty-dynamic-3d-HF7KVBOE.js
...
var AxisInfo = class {
  constructor(vector, fromZ, color, dimColor, hintOpacityScale, options) {
    ...
    this.hintStickerMaterial = {
      regular: new MeshBasicMaterial({
        color: new Color((options == null ? void 0 : options.hintColor) ?? color).convertLinearToSRGB(),
        side: BackSide,
        transparent: true,
      ...
      dim: new MeshBasicMaterial({
        color: new Color(
          (options == null ? void 0 : options.hintDimColor) ?? dimColor
        ).convertLinearToSRGB(),
        side: BackSide,
        transparent: true,
        opacity: 0.5 * hintOpacityScale
...
var _sharedHintStickerGeometryCache, _Cube3D_instances, sharedHintStickerGeometry_fn, animateRaiseHintFacelets_fn, _a;
var Cube3D = (_a = class extends Object3D {
  constructor(kpuzzle, scheduleRenderCallback, options = {}) {
    super();
    __privateAdd(this, _Cube3D_instances);
    ...
    __privateMethod(this, _Cube3D_instances, animateRaiseHintFacelets_fn).call(this);
        ...
        if (pieceStickeringMask) {
          ...
          for (let faceletIdx = 0; faceletIdx < pieceInfo.length; faceletIdx++) {
            ...
            if (faceletStickeringMask) {
              ...
              const stickeringMask2 = typeof faceletStickeringMask === "string" ? faceletStickeringMask : faceletStickeringMask == null ? void 0 : faceletStickeringMask.mask;
  ...
  createCubie(orbit, orbitFacelets, piece, orbitPieceIdx) {
    ...
    for (let i = 0; i < piece.stickerFaces.length; i++) {
      ...
      if (((_a3 = this.options.experimentalStickeringMask) == null ? void 0 : _a3.specialBehaviour) === "picture" && pictureStickerCoords[orbit] && pictureStickerCoords[orbit][orbitPieceIdx] && pictureStickerCoords[orbit][orbitPieceIdx][i]) {
  ...
  createCubieFoundation() {
    ...
    return new Mesh(
      box,
      ((_a3 = this.options.experimentalStickeringMask) == null ? void 0 : _a3.specialBehaviour) === "picture" ? blackMesh : blackTranslucentMesh
    );
  }
  createSticker(posAxisInfo, materialAxisInfo, isHint) {
    var _a3, _b;
    const geo = ((_a3 = this.options.experimentalStickeringMask) == null ? void 0 : _a3.specialBehaviour) === "picture" ? newStickerGeometry() : isHint ? __privateMethod(this, _Cube3D_instances, sharedHintStickerGeometry_fn).call(this) : sharedStickerGeometry();
    ...
    stickerMesh.position.multiplyScalar(
      isHint ? ((_b = this.options.experimentalStickeringMask) == null ? void 0 : _b.specialBehaviour) === "picture" ? EXPERIMENTAL_PICTURE_CUBE_HINT_ELEVATION : cubieDimensions.hintStickerElevation : cubieDimensions.stickerElevation
    );
    ...
    for (const orbitInfo of Object.values(this.kpuzzleFaceletInfo)) {
      for (const pieceInfo of orbitInfo) {
        for (const faceletInfo of pieceInfo) {
          ...
          (_a3 = faceletInfo.hintFacelet) == null ? void 0 : _a3.scale.setScalar(
...
}, _sharedHintStickerGeometryCache = new WeakMap(), _Cube3D_instances = new WeakSet(), sharedHintStickerGeometry_fn = function() {
...
animateRaiseHintFacelets_fn = function() {
  ...
  __privateMethod(this, _Cube3D_instances, sharedHintStickerGeometry_fn).call(this).translate(0, 0, -translationRange);
  setTimeout(() => {
    ...
    const animateRaiseHintSticker = () => {
      ...
      __privateMethod(this, _Cube3D_instances, sharedHintStickerGeometry_fn).call(this).translate(
        0,
        0,
      ...
      if (elapsed < translationDuration) {
        ...
        (_a3 = this.scheduleRenderCallback) == null ? void 0 : _a3.call(this);
      }
    };
...
var StickerDef = class {
  constructor(filler, stickerDat, trim, options) {
    ...
    if (options == null ? void 0 : options.stickeringMask) {
...
var PG_SCALE = 0.5;
var _pendingStickeringUpdate, _PG3D_instances, isValidMove_fn, _a2;
var PG3D = (_a2 = class extends Object3D {
  constructor(scheduleRenderCallback, kpuzzle, stickerDat, enableFoundationOpt = false, enableHintStickersOpt = false, hintStickerHeightScale = 1, faceletScale = 1, params = {}) {
    super();
    __privateAdd(this, _PG3D_instances);
  ...
  getClosestMoveToAxis(point, transformations) {
    ...
    for (const axis of this.stickerDat.axis) {
      ...
      if (product > closestMoveDotProduct) {
        ...
        if (__privateMethod(this, _PG3D_instances, isValidMove_fn).call(this, modified)) {
...
}, _pendingStickeringUpdate = new WeakMap(), _PG3D_instances = new WeakSet(), isValidMove_fn = function(move) {
  try {
...
//# sourceMappingURL=twisty-dynamic-3d-HF7KVBOE-F35VKDZV.js.map
