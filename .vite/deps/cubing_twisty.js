...
var _TwistyAnimationController_instances, effectiveTimestampMilliseconds_fn, _animFrameEffectiveTimestampStaleDropper, _a;
var TwistyAnimationController = (_a = class {
  constructor(model, delegate) {
    __privateAdd(this, _TwistyAnimationController_instances);
    // TODO: #private?
    ...
    this.model = model;
    this.lastTimestampPromise = __privateMethod(this, _TwistyAnimationController_instances, effectiveTimestampMilliseconds_fn).call(this);
  ...
  jumpToStart(options) {
    ...
    this.pause();
    if (options == null ? void 0 : options.flash) {
      this.delegate.flash();
    }
  }
  // TODO: Return the animation we've switched to.
  ...
  async play(options) {
    ...
    if ((options == null ? void 0 : options.autoSkipToOtherEndIfStartingAtBoundary) ?? true) {
    ...
    this.model.playingInfo.set({
      playing: true,
      direction,
      untilBoundary: (options == null ? void 0 : options.untilBoundary) ?? "entire-timeline",
...
}, _TwistyAnimationController_instances = new WeakSet(), effectiveTimestampMilliseconds_fn = async function() {
...
var TwistyAnimatedSVG = class {
    ...
    for (const orbitDefinition of kpuzzle.definition.orbits) {
      for (let idx = 0; idx < orbitDefinition.numPieces; idx++) {
        for (let orientation = 0; orientation < orbitDefinition.numOrientations; orientation++) {
          ...
          let originalColor = elem == null ? void 0 : elem.style.fill;
          if (experimentalStickeringMask) {
            (() => {
              ...
              const stickeringMask = typeof faceletStickeringMasks === "string" ? faceletStickeringMasks : faceletStickeringMasks == null ? void 0 : faceletStickeringMasks.mask;
            ...
            originalColor = elem == null ? void 0 : elem.style.fill;
          }
          ...
          elem == null ? void 0 : elem.setAttribute("style", `fill: url(#grad-${this.svgID}-${id})`);
        }
      }
    }
  ...
  draw(pattern, nextPattern, fraction) {
    var _a17;
    const nextTransformation = nextPattern == null ? void 0 : nextPattern.experimentalToTransformation();
    if (!pattern) {
    ...
    for (const orbitDefinition of pattern.kpuzzle.definition.orbits) {
      ...
      for (let idx = 0; idx < orbitDefinition.numPieces; idx++) {
        for (let orientation = 0; orientation < orbitDefinition.numOrientations; orientation++) {
          ...
          if (singleColor) {
            if (this.showUnknownOrientations && ((_a17 = currentPatternOrbit.orientationMod) == null ? void 0 : _a17[idx]) === 1) {
...
var Twisty2DPuzzle = (_a2 = class extends ManagedCustomElement {
  ...
  constructor(model, kpuzzle, svgSource, options, puzzleLoader) {
    ...
    __privateGet(this, _freshListenerManager).addListener(
      this.model.puzzleID,
      (puzzleID) => {
        if ((puzzleLoader == null ? void 0 : puzzleLoader.id) !== puzzleID) {
          this.disconnect();
        }
      }
    );
    ...
    if ((_a17 = this.options) == null ? void 0 : _a17.experimentalStickeringMask) {
  ...
  onPositionChange(position) {
    ...
    try {
      ...
      console.warn(
        ...
        (_a17 = this.puzzleLoader) == null ? void 0 : _a17.id,
        e
      );
      this.disconnect();
    }
...
var Twisty2DSceneWrapper = (_a4 = class extends ManagedCustomElement {
  constructor(model, effectiveVisualization) {
    ...
    __privateAdd(this, _cachedScene);
  ...
  scheduleRender() {
    var _a17;
    (_a17 = __privateGet(this, _currentTwisty2DPuzzleWrapper)) == null ? void 0 : _a17.scheduleRender();
  }
  ...
  async setCurrentTwisty2DPuzzleWrapper(twisty2DPuzzleWrapper) {
    ...
    old == null ? void 0 : old.disconnect();
  ...
  async onPuzzleLoader(puzzleLoader) {
    var _a17;
    (_a17 = __privateGet(this, _currentTwisty2DPuzzleWrapper)) == null ? void 0 : _a17.disconnect();
...
var Twisty3DSceneWrapper = (_a8 = class extends ManagedCustomElement {
  constructor(model) {
    ...
    __privateAdd(this, _cachedScene2);
  ...
  removeVantage(vantage) {
    ...
    vantage.remove();
    vantage.disconnect();
    (_a17 = __privateGet(this, _currentTwisty3DPuzzleWrapper)) == null ? void 0 : _a17.disconnect();
  }
...
var fullscreenEnabled = (globalSafeDocument == null ? void 0 : globalSafeDocument.fullscreenEnabled) || !!(globalSafeDocument == null ? void 0 : globalSafeDocument.webkitFullscreenEnabled);
...
var TwistyButtons = (_a9 = class extends ManagedCustomElement {
  ...
  connectedCallback() {
    ...
    for (const command in buttonCommands) {
      ...
      button.htmlButton.addEventListener(
        "click",
        () => __privateMethod(this, _TwistyButtons_instances, onCommand_fn).call(this, command)
      );
      this.addElement(button);
    }
    this.buttons = buttons;
    (_a17 = this.model) == null ? void 0 : _a17.buttonAppearance.addFreshListener(this.update.bind(this));
    (_b = this.model) == null ? void 0 : _b.twistySceneModel.colorScheme.addFreshListener(
  ...
  async onFullscreenButton() {
    ...
    if (documentFullscreenElement() === this.defaultFullscreenElement) {
      ...
      (_a17 = this.buttons) == null ? void 0 : _a17.fullscreen.setIcon("exit-fullscreen");
      requestFullscreen(
        await ((_b = this.model) == null ? void 0 : _b.twistySceneModel.fullscreenElement.get()) ?? this.defaultFullscreenElement
      );
      const onFullscreen = () => {
        var _a18;
        if (documentFullscreenElement() !== this.defaultFullscreenElement) {
          (_a18 = this.buttons) == null ? void 0 : _a18.fullscreen.setIcon("enter-fullscreen");
...
}, _TwistyButtons_instances = new WeakSet(), onCommand_fn = function(command) {
  ...
  switch (command) {
    ...
    case "jump-to-start": {
      (_a17 = this.controller) == null ? void 0 : _a17.jumpToStart({ flash: true });
      break;
    }
    case "play-step-backwards": {
      (_b = this.controller) == null ? void 0 : _b.animationController.play({
        direction: -1,
        untilBoundary: "move"
        /* Move */
      });
    ...
    case "play-pause": {
      (_c = this.controller) == null ? void 0 : _c.togglePlay();
      break;
    }
    case "play-step": {
      (_d = this.controller) == null ? void 0 : _d.animationController.play({
        direction: 1,
        untilBoundary: "move"
        /* Move */
      });
    ...
    case "jump-to-end": {
      (_e = this.controller) == null ? void 0 : _e.jumpToEnd({ flash: true });
      break;
    }
    case "twizzle-link": {
      (_f = this.controller) == null ? void 0 : _f.visitTwizzleLink();
      break;
    }
    default:
...
globalSafeDocument == null ? void 0 : globalSafeDocument.addEventListener(
  "mousedown",
  (event) => {
    if (event.which) {
      isMouseDown = true;
...
globalSafeDocument == null ? void 0 : globalSafeDocument.addEventListener("mousemove", onMouseUpdate, false);
globalSafeDocument == null ? void 0 : globalSafeDocument.addEventListener("mouseenter", onMouseUpdate, false);
...
var TwistyScrubber = (_a11 = class extends ManagedCustomElement {
  ...
  async connectedCallback() {
    ...
    (_a17 = this.model) == null ? void 0 : _a17.twistySceneModel.colorScheme.addFreshListener(
      this.updateColorScheme.bind(this)
    );
  }
  updateColorScheme(colorScheme) {
  ...
  async inputElem() {
    return __privateGet(this, _inputElem) ?? __privateSet(this, _inputElem, (async () => {
      ...
      elem.type = "range";
      elem.disabled = true;
      (_a17 = this.model) == null ? void 0 : _a17.detailedTimelineInfo.addFreshListener(
  ...
  async onInput(e) {
    ...
    (_a17 = this.model) == null ? void 0 : _a17.playingInfo.set({ playing: false });
    (_b = this.model) == null ? void 0 : _b.timestampRequest.set(value);
  }
  onKeypress(e) {
    var _a17, _b;
    switch (e.key) {
      case "ArrowLeft":
      case "ArrowRight": {
        (_a17 = this.controller) == null ? void 0 : _a17.animationController.play({
      ...
      case " ": {
        (_b = this.controller) == null ? void 0 : _b.togglePlay();
        e.preventDefault();
        break;
      }
    }
...
async function screenshot(model, options) {
  ...
  const width = (options == null ? void 0 : options.width) ?? 2048;
  const height = (options == null ? void 0 : options.height) ?? 2048;
...
var AlgIssues = class _AlgIssues {
  constructor(issues) {
    ...
    this.warnings = Object.freeze((issues == null ? void 0 : issues.warnings) ?? []);
    this.errors = Object.freeze((issues == null ? void 0 : issues.errors) ?? []);
    Object.freeze(this);
  }
  add(issues) {
    return new _AlgIssues({
      warnings: this.warnings.concat((issues == null ? void 0 : issues.warnings) ?? []),
      errors: this.errors.concat((issues == null ? void 0 : issues.errors) ?? [])
    });
  }
  /** @deprecated */
  log() {
  ...
  derive(inputs) {
    ...
    if (inputs.indexer.currentMoveInfo) {
      ...
      if (inputs.indexer.numAnimatedLeaves() > 0) {
        const move = (_a17 = inputs.indexer.getAnimLeaf(idx)) == null ? void 0 : _a17.as(Move);
        if (!move) {
...
var SimultaneousMoveIndexer = class {
  ...
  getAnimLeaf(index) {
    var _a17;
    return ((_a17 = this.animLeaves[Math.min(index, this.animLeaves.length - 1)]) == null ? void 0 : _a17.animLeaf) ?? null;
  }
...
var _DetailedTimelineInfoProp_instances, requestedTimestampToMilliseconds_fn, _a12;
var DetailedTimelineInfoProp = (_a12 = class extends TwistyPropDerived {
  constructor() {
    super(...arguments);
    __privateAdd(this, _DetailedTimelineInfoProp_instances);
  }
  derive(inputs) {
    let timestamp = __privateMethod(this, _DetailedTimelineInfoProp_instances, requestedTimestampToMilliseconds_fn).call(this, inputs);
    let atStart = false;
    let atEnd = false;
...
}, _DetailedTimelineInfoProp_instances = new WeakSet(), requestedTimestampToMilliseconds_fn = function(inputs) {
...
var StickeringMaskProp = class extends TwistyPropDerived {
  ...
  async derive(inputs) {
    ...
    return ((_b = (_a17 = inputs.puzzleLoader).stickeringMask) == null ? void 0 : _b.call(
      _a17,
...
var _controlsManager, _visualizationWrapperElem, _errorElem, _alreadyConnected, _flashLevel, _visualizationWrapper, _initial3DVisualizationWrapper, _visualizationStrategy, _TwistyPlayer_instances, setVisualizationWrapper_fn, _a13;
var TwistyPlayer = (_a13 = class extends TwistyPlayerSettable {
  // #onCanvasClick() {
  // }
  constructor(config = {}) {
    super();
    __privateAdd(this, _TwistyPlayer_instances);
  ...
  async connectedCallback() {
    ...
    this.experimentalModel.visualizationStrategy.addFreshListener(
      __privateMethod(this, _TwistyPlayer_instances, setVisualizationWrapper_fn).bind(this)
    );
  ...
  flash() {
    ...
    if (__privateGet(this, _flashLevel) === "auto") {
      (_a17 = __privateGet(this, _visualizationWrapper)) == null ? void 0 : _a17.animate([{ opacity: 0.25 }, { opacity: 1 }], {
        duration: 250,
        easing: "ease-out"
      });
    }
...
}, _controlsManager = new WeakMap(), _visualizationWrapperElem = new WeakMap(), _errorElem = new WeakMap(), _alreadyConnected = new WeakMap(), _flashLevel = new WeakMap(), _visualizationWrapper = new WeakMap(), _initial3DVisualizationWrapper = new WeakMap(), _visualizationStrategy = new WeakMap(), _TwistyPlayer_instances = new WeakSet(), setVisualizationWrapper_fn = function(strategy) {
  var _a17, _b;
  if (strategy !== __privateGet(this, _visualizationStrategy)) {
    (_a17 = __privateGet(this, _visualizationWrapper)) == null ? void 0 : _a17.remove();
    (_b = __privateGet(this, _visualizationWrapper)) == null ? void 0 : _b.disconnect();
    let newWrapper;
    switch (strategy) {
      case "2D":
      case "experimental-2D-LL":
...
var AlgToDOMTree = class extends TraversalDownUp {
  traverseAlg(alg, dataDown) {
    ...
    for (const algNode of direct(
      ...
      first = false;
      if ((_a17 = algNode.as(Pause)) == null ? void 0 : _a17.experimentalNISSGrouping) {
        element.addString("^(");
      }
      if (!((_b = algNode.as(Grouping)) == null ? void 0 : _b.experimentalNISSPlaceholder)) {
      ...
      if ((_c = algNode.as(Pause)) == null ? void 0 : _c.experimentalNISSGrouping) {
        element.addString(")");
      }
    }
...
var MoveHighlighter = class {
  ...
  set(move) {
    ...
    (_a17 = this.currentElem) == null ? void 0 : _a17.classList.remove("twisty-alg-current-move");
    (_b = this.currentElem) == null ? void 0 : _b.setCurrentMove(false);
    newElem == null ? void 0 : newElem.classList.add("twisty-alg-current-move");
    newElem == null ? void 0 : newElem.setCurrentMove(true);
    this.currentElem = newElem;
  }
};
var _domTree, _twistyPlayer, _TwistyAlgViewer_instances, setTwistyPlayer_fn, _a14;
var TwistyAlgViewer = (_a14 = class extends HTMLElementShim {
  constructor(options) {
    super();
    __privateAdd(this, _TwistyAlgViewer_instances);
    __publicField(this, "highlighter", new MoveHighlighter());
    __privateAdd(this, _domTree);
    __privateAdd(this, _twistyPlayer, null);
    __publicField(this, "lastClickTimestamp", null);
    if (options == null ? void 0 : options.twistyPlayer) {
      this.twistyPlayer = options == null ? void 0 : options.twistyPlayer;
    }
  }
  connectedCallback() {
  }
  ...
  set twistyPlayer(twistyPlayer) {
    __privateMethod(this, _TwistyAlgViewer_instances, setTwistyPlayer_fn).call(this, twistyPlayer);
  }
...
}, _domTree = new WeakMap(), _twistyPlayer = new WeakMap(), _TwistyAlgViewer_instances = new WeakSet(), setTwistyPlayer_fn = async function(twistyPlayer) {
...
function pasteIntoTextArea(textArea, pastedText) {
  ...
  const execCommandSuccess = globalSafeDocument == null ? void 0 : globalSafeDocument.execCommand(
    "insertText",
    false,
    replacement
  );
...
var _textarea, _carbonCopy, _carbonCopyPrefix, _carbonCopyHighlight, _carbonCopySuffix, _textareaClassListValidForPuzzleManager, _twistyPlayer2, _twistyPlayerProp, _TwistyAlgEditor_instances, algProp_get, _onInputHasFired, padSuffix_fn, _highlightedLeaf, _a15;
var TwistyAlgEditor = (_a15 = class extends ManagedCustomElement {
  constructor(options) {
    super();
    __privateAdd(this, _TwistyAlgEditor_instances);
    ...
    __privateAdd(this, _twistyPlayerProp);
    ...
    __privateSet(this, _twistyPlayerProp, (options == null ? void 0 : options.twistyPlayerProp) ?? "alg");
    if ((options == null ? void 0 : options.twistyPlayerProp) === "alg") {
  ...
  connectedCallback() {
    __privateGet(this, _textarea).addEventListener("paste", (e) => {
      var _a17;
      const text = (_a17 = e.clipboardData) == null ? void 0 : _a17.getData("text");
      if (text) {
  ...
  onInput() {
    ...
    (_a17 = __privateGet(this, _TwistyAlgEditor_instances, algProp_get)) == null ? void 0 : _a17.set(endTrimmed);
  }
  ...
  highlightLeaf(leaf) {
    ...
    if (leaf === null) {
      ...
      __privateGet(this, _carbonCopySuffix).textContent = __privateMethod(this, _TwistyAlgEditor_instances, padSuffix_fn).call(this, __privateGet(this, _textarea).value);
      return;
    }
    ...
    __privateGet(this, _carbonCopySuffix).textContent = __privateMethod(this, _TwistyAlgEditor_instances, padSuffix_fn).call(this, __privateGet(this, _textarea).value.slice(leaf.endCharIndex));
  ...
  set twistyPlayer(twistyPlayer) {
    ...
    (async () => {
      this.algString = __privateGet(this, _TwistyAlgEditor_instances, algProp_get) ? (await __privateGet(this, _TwistyAlgEditor_instances, algProp_get).get()).alg.toString() : "";
    })();
    if (__privateGet(this, _twistyPlayerProp) === "alg") {
      (_a17 = __privateGet(this, _twistyPlayer2)) == null ? void 0 : _a17.experimentalModel.puzzleAlg.addFreshListener(
        (algWithIssues) => {
...
}, _textarea = new WeakMap(), _carbonCopy = new WeakMap(), _carbonCopyPrefix = new WeakMap(), _carbonCopyHighlight = new WeakMap(), _carbonCopySuffix = new WeakMap(), _textareaClassListValidForPuzzleManager = new WeakMap(), _twistyPlayer2 = new WeakMap(), _twistyPlayerProp = new WeakMap(), _TwistyAlgEditor_instances = new WeakSet(), algProp_get = function() {
...
}, _onInputHasFired = new WeakMap(), // `white-space: pre;` mostly matches the formatting of the `<textarea>`, *except* when we end with a newline.
...
var _TwizzleLink_instances, fallback_fn, _cssCDNForumTweaksElem, _scrollableRegion, _responsiveWrapper, _moveCountElem, addHeading_fn, _a16;
var TwizzleLink = (_a16 = class extends ManagedCustomElement {
  constructor(options) {
    super({ mode: "open" });
    __privateAdd(this, _TwizzleLink_instances);
    __publicField(this, "twistyPlayer", null);
    __publicField(this, "a", null);
    __privateAdd(this, _cssCDNForumTweaksElem);
    __privateAdd(this, _scrollableRegion);
    __privateAdd(this, _responsiveWrapper);
    __privateAdd(this, _moveCountElem);
    this.options = options;
  }
  async connectedCallback() {
    ...
    if (((_a17 = this.options) == null ? void 0 : _a17.colorScheme) === "dark") {
      this.contentWrapper.classList.add("dark-mode");
    }
    this.addCSS(twizzleLinkCSS);
    if ((_b = this.options) == null ? void 0 : _b.cdnForumTweaks) {
    ...
    const href = (_c = this.a) == null ? void 0 : _c.href;
    const { hostname, pathname } = new URL(href);
    if (hostname !== "alpha.twizzle.net") {
      __privateMethod(this, _TwizzleLink_instances, fallback_fn).call(this);
      return;
    }
    if (["/edit/", "/explore/"].includes(pathname)) {
      const isExplorer = pathname === "/explore/";
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./puzzle-geometry-OIDTSNXH.js")).getPuzzleDescriptionString(config.puzzle);
      ...
      this.twistyPlayer = __privateGet(this, _responsiveWrapper).appendChild(
        new TwistyPlayer({
          background: ((_d = this.options) == null ? void 0 : _d.cdnForumTweaks) ? "checkered-transparent" : "checkered",
          colorScheme: ((_e = this.options) == null ? void 0 : _e.colorScheme) === "dark" ? "dark" : "light",
          ...config,
      ...
      if (config.experimentalTitle) {
        __privateMethod(this, _TwizzleLink_instances, addHeading_fn).call(this, config.experimentalTitle).classList.add("title");
      }
      if (config.experimentalSetupAlg) {
        __privateMethod(this, _TwizzleLink_instances, addHeading_fn).call(this, "Setup", async () => {
          var _a18, _b2;
          return ((_b2 = await ((_a18 = this.twistyPlayer) == null ? void 0 : _a18.experimentalModel.setupAlg.get())) == null ? void 0 : _b2.alg.toString()) ?? null;
        });
      ...
      const movesHeading = __privateMethod(this, _TwizzleLink_instances, addHeading_fn).call(this, "Moves", async () => {
        var _a18, _b2;
        return ((_b2 = await ((_a18 = this.twistyPlayer) == null ? void 0 : _a18.experimentalModel.alg.get())) == null ? void 0 : _b2.alg.toString()) ?? null;
      });
...
}, _TwizzleLink_instances = new WeakSet(), fallback_fn = function() {
  var _a17;
  this.contentWrapper.textContent = "";
  if (this.a) {
  ...
  (_a17 = __privateGet(this, _cssCDNForumTweaksElem)) == null ? void 0 : _a17.remove();
}, _cssCDNForumTweaksElem = new WeakMap(), _scrollableRegion = new WeakMap(), _responsiveWrapper = new WeakMap(), _moveCountElem = new WeakMap(), addHeading_fn = function(text, getTextToCopy) {
...
//# sourceMappingURL=cubing_twisty.js.map
