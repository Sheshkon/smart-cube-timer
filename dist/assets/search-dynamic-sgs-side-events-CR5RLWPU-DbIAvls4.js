const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CKzXfnt9.js","assets/index-89KQPpsQ.js","assets/index-BpCsZESN.css"])))=>i.map(i=>d[i]);
import{y as e,u as t,_ as B,w as D}from"./index-89KQPpsQ.js";import{p as R}from"./chunk-BQNTAVTA-BkTYeDmU.js";var a=null;async function S(){return a??(a=n())}async function n(){return R(await e.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var y=null;async function s(){return y??(y=m())}async function b(){return{ordering:(await s()).ordering.slice(2)}}async function m(){return R(await t.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg U R' U' L B R' B' R
Alg R' U' R U B' U' B L`)}export{S as cachedData222,u as cachedMegaminxKPuzzleWithoutMO,h as cachedSGSDataMegaminx,s as sgsDataPyraminx,b as sgsDataPyraminxFixedOrientation,f as sgsDataSkewb,G as sgsDataSkewbFixedCorner,v as skewbKPuzzleWithoutMOCached};
